              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('085021002', style: vkTextCardBold),
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('Sistem Informasi', style: vkTextCardBold),
                  ],
                ),
                const Divider(color: Colors.white),
                Row(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Delima Sari Dewi', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Deli', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Alamat : JL. Padi No. 2, Kelurahan Baranangsiang, Kecamatan Bogor Timur, Bogor, Jawa Barat, Indonesia, 16143',
